...
namespace DioSeries
{
    class Program
    {
        ...
        private static void AtualizarSerie()
		{
			...
			foreach (int i in Enum.GetValues(typeof(Genero1)))
			{
				Console.WriteLine("{0}-{1}", i, Enum.GetName(typeof(Genero1), i));
			}
    ...
    internal class SerieRepositorio
    {
        ...
        internal void Exclui(int indiceSerie)
        {
            throw new NotImplementedException();
        }
